...
<head>
    ...
    <title>Newsletter Subscribers - KHODERS Admin</title>
    <style>
        ...
        <div class="content-area">
            ...
            <div class="table-container">
                <div class="table-header">
                    <h2>Subscribers (<?php echo count($entries); ?>)</h2>
                </div>
                <?php if (!$tableExists): ?>
                    <p style="padding: 1.5rem; color: #B91C1C;">The newsletter table is missing. Run the latest database migrations from <code>database/schema_updates.sql</code>.</p>
                <?php else: ?>
                    <table>
                        <thead>
                            <tr>
                            ...
                            <?php else: ?>
                                <?php foreach ($entries as $row): ?>
                                    <tr>
                                        ...
                                        <?php if ($hasIdColumn): ?>
                                            <td class="actions">
                                                <a href="?action=delete&id=<?php echo admin_safe($row['id']); ?>" class="btn btn-danger" onclick="return confirm('Remove this subscriber?');">Delete</a>
                                            </td>
                                        <?php endif; ?>
                                    </tr>
                                <?php endforeach; ?>
