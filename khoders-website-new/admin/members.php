    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-menu">
            ...
            <div class="menu-section">
                ...
                <a href="newsletter.php" class="menu-item">
                    <span class="menu-item-icon">📧</span>
                    Newsletter
                </a>
            </div>
                        ...
                        <?php else: ?>
                            <?php foreach ($members as $member): ?>
                                <tr>
                                    ...
                                    <td><?php echo htmlspecialchars($member['program'] . ' / ' . $member['year']); ?></td>
                                    <td>
                                        <span class="badge badge-<?php echo htmlspecialchars($member['experience']); ?>">
                                            <?php echo ucfirst(str_replace('-', ' ', $member['experience'])); ?>
                                        </span>
                                    </td>
