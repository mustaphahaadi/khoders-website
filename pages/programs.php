...
if ($db) {
    try {
        $query = "SELECT * FROM programs WHERE status = 'active' ORDER BY id ASC";
        ...
        if (empty($programs)) {
            error_log('[DEBUG] No active programs found in database');
        }
  ...
  <div class="container">
    <?php if (empty($programs)): ?>
      <div class="alert alert-info text-center">
        ...
        <p class="small text-muted">If you're an admin, please add programs through the admin panel.</p>
      </div>
    <?php else: ?>
    <div class="row gy-4">
      ...
      <div class="col-lg-6" data-aos="fade-up" data-aos-delay="<?php echo 100 + ($index * 50); ?>">
        <div class="course-card">
          ...
          <div class="course-content">
            ...
            <a href="index.php?page=program-details&id=<?php echo (int)($program['id'] ?? 0); ?>" class="btn-course">Learn More</a>
          </div>
        </div>
      </div>
      <?php endforeach; ?>
